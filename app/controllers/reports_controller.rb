class ReportsController < ApplicationController
  ...
  def form_scarichi
    authorize :report
    @cache_users = User.all_in_cache(current_organization.id, interval: 1500)
  ...
  def leggi_date
    @from = params[:report][:start_date] or Date.today.to_s
    @to = params[:report][:end_date] or Date.tomorrow.to_s
  end
end
